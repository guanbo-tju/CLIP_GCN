...
class Config(object):
    ...
    def __init__(self):
        ...
        self.log_dir = "logs/home_made_new_class_log0/" # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
            "/media/imris/guanbo/CLIP_GCN/hover_net-master/datasets/home_made_new/datasets_npy_class/train"
        ]
        self.valid_dir_list = [
            "/media/imris/guanbo/CLIP_GCN/hover_net-master/datasets/home_made_new/datasets_npy_class/valid"
        ]
